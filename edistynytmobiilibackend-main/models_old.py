...
from sqlalchemy import Column, DateTime, ForeignKeyConstraint, Index, Integer, String, Text, create_engine
from sqlalchemy.orm import Mapped, declarative_base, mapped_column, relationship, sessionmaker, Session
from sqlalchemy.orm.base import Mapped

engine = create_engine(f'postgresql+psycopg2://postgres:salasana@localhost/edistynytmobiilidb')
